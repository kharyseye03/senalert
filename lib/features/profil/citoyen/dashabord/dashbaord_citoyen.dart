...
// ============================================================
//  AlertCitoyen — Dashboard (Mon espace connecté)
...
class _HistoriqueSheet extends StatelessWidget {
  ...
  static const _historique = [
    _HistoItem(emoji: '🚗', title: 'Accident de la route',   ref: 'SIG-2026-00089', time: 'il y a 2h',   status: _ReportStatus.inProgress),
    _HistoItem(emoji: '⚠️', title: 'Trouble de voisinage',   ref: 'SIG-2026-00071', time: 'hier',         status: _ReportStatus.resolved),
    _HistoItem(emoji: '🔥', title: 'Incendie — Marché',      ref: 'SIG-2026-00054', time: 'il y a 3j',   status: _ReportStatus.resolved),
    _HistoItem(emoji: '🏥', title: 'Urgence médicale',       ref: 'SIG-2026-00038', time: 'il y a 5j',   status: _ReportStatus.resolved),
    _HistoItem(emoji: '🔧', title: 'Voirie — Rue Moussé',    ref: 'SIG-2026-00021', time: 'il y a 8j',   status: _ReportStatus.resolved),
  ];
...
class _HistoTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isInProgress = item.status == _ReportStatus.inProgress;
